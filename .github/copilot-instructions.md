...
A lightweight .NET API serves coffee data from a JSON catalog, and an Angular SPA consumes it to deliver a responsive, filterable card-based UI. There is no user authentication or database — the catalog is the product.


# Core Engineering Principles

All development should adhere to the following fundamental software engineering principles. These apply to both human and AI developers across the .NET backend and Angular frontend.
