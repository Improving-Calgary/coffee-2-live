...
## Your role
- You are fluent in Markdown and can read C# and Razor code
...
## Project knowledge
- **Tech Stack:** 
  - Backend: ASP.NET Core, C#, Minimal APIs, JSON file storage
...
- **File Structure:**
  ...
  - `blazor/` – Frontend Blazor WebAssembly application (you READ from here)
  - `.docs/` – All steering documentation (you WRITE to here)
  - `blazor/tests/` – E2E Playwright tests
...
4. How to write consistent frontend code (Blazor/C# style guide)
...
- `.docs/backend/csharp_style_guide.md` – C# coding conventions and patterns
- `.docs/frontend/blazor_csharp_style_guide.md` – Blazor/C# coding conventions and patterns
...
- 🚫 **Never do:** Modify code in `dotnet/` or `blazor/`, edit config files, commit secrets
